...
-- keymappings
keymap("i", "<C-e>", "<Plug>luasnip-expand-snippet")
keymap("s", "<C-e>", "<Plug>luasnip-expand-snippet")
keymap("i", "<C-j>", "<Plug>luasnip-jump-next")
keymap("s", "<C-j>", "<Plug>luasnip-jump-next")
keymap("i", "<C-k>", "<Plug>luasnip-jump-prev")
keymap("s", "<C-k>", "<Plug>luasnip-jump-prev")
keymap("i", "<C-l>", "<cmd>lua require('luasnip.extras.select_choice')()<cr>")

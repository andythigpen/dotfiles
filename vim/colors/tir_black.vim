...
hi LineNr guifg=#3D3D3D guibg=black ctermfg=236 ctermbg=0

hi VertSplit guifg=#202020 guibg=#202020 ctermfg=235 ctermbg=235 
hi StatusLine guifg=#CCCCCC guibg=#202020 gui=italic ctermfg=238 ctermbg=254
hi StatusLineNC guifg=black guibg=#202020 ctermfg=234 ctermbg=236 
...
hi ModeMsg guifg=black guibg=#C6C5FE gui=bold ctermfg=187 ctermbg=0 cterm=bold
